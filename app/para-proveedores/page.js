...
const footerStats = [
  {
    ...
    icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
  },
  {
    label: "Presencia en LATAM", sub: "Múltiples países",
    icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg>,
  },
  {
    label: "Transacciones seguras", sub: "Pagos protegidos",
    icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>,
  },
  {
    label: "Soporte dedicado", sub: "Estamos contigo",
    icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.8a16 16 0 0 0 5.29 5.29l.91-.91a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>,
  },
];
      ...
      <section className="provider-hero-animated" style={{ position: "relative", minHeight: 480, display: "flex", alignItems: "center", borderBottom: `1px solid ${w(0.06)}`, overflow: "hidden" }}>
        ...
        <div className="shell provider-hero-copy" style={{ position: "relative", zIndex: 1, padding: "80px 0" }}>
          ...
          <h1 className="provider-reveal provider-delay-2" style={{ fontSize: "clamp(2rem, 4vw, 3.2rem)", fontWeight: 800, lineHeight: 1.15, margin: "0 0 20px", maxWidth: 560, color: "#fff" }}>
            Lleva tu marca<br />
            <span style={{ color: "#7FE040" }}>a nuevos mercados</span><br />
            sin fronteras
          </h1>
        ...
        <div className="shell">
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 800, margin: "0 0 8px" }}>
              ...
              <span style={{ color: "#7FE040" }}>tu negocio</span>
            </h2>
          </div>
              ...
              <div style={{ padding: 32 }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 20 }}>
                  <div style={{
                    ...
                    fontWeight: 800, color: "rgba(255,255,255,0.5)", fontSize: "1rem",
                  }}>1</div>
                  <div>
                    <h3 style={{ margin: "0 0 3px", fontSize: "1.2rem", fontWeight: 800, color: "rgba(255,255,255,0.75)" }}>Proveedor Explorer</h3>
                    <p style={{ margin: 0, color: "rgba(255,255,255,0.35)", fontWeight: 600, fontSize: "0.85rem" }}>Valida tu mercado</p>
                  </div>
                </div>
                <p style={{ color: w(0.45), lineHeight: 1.65, marginBottom: 20, fontSize: "0.9rem" }}>
                  Publica tus productos y recibe <strong style={{ color: "rgba(255,255,255,0.6)" }}>contactos y cotizaciones</strong> de compradores interesados.
                </p>
                <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
                  {["Publica tus productos", "Recibe contactos y cotizaciones", "Mide el interés real en otros países", "Sin necesidad de tener stock"].map(f => (
                    <div key={f} style={{ display: "flex", alignItems: "center", gap: 10, fontSize: "0.88rem", color: w(0.45) }}>
                      <svg width="14" height="14" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="7" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5"/><path d="M5 8l2 2 4-4" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg> {f}
                    </div>
                  ))}
                </div>
            ...
            <div className="provider-card-animated provider-card-pro" style={{
              ...
              <div style={{ padding: "24px 20px 24px 24px", position: "relative" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 20 }}>
                  ...
                  <div>
                    <h3 style={{ margin: "0 0 3px", fontSize: "1.2rem", fontWeight: 800, color: "#fff" }}>Proveedor Pro</h3>
                    <p style={{ margin: 0, color: "#F59E0B", fontWeight: 700, fontSize: "0.85rem" }}>Vende directamente</p>
                  </div>
                </div>
        ...
        <div className="shell" style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 24, alignItems: "start" }}>
          <div>
            <h2 style={{ fontSize: "clamp(1.3rem, 2.5vw, 1.7rem)", fontWeight: 800, margin: "0 0 28px" }}>
              ¿Qué incluye <span style={{ color: "#7FE040" }}>cada opción</span>?
            </h2>
          ...
          <div className="provider-side-card-animated" style={{
            ...
            <Link className="provider-hover-lift" href="/registro" style={{
              ...
              Así de simple <span style={{ color: "#7FE040" }}>→</span>
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className="provider-experience-banner" style={{ position: "relative", borderRadius: 20, overflow: "hidden", border: "1px solid rgba(127, 224, 64, 0.15)", minHeight: 320 }}>
            ...
            <div style={{ position: "relative", zIndex: 2, padding: "44px 40px", maxWidth: 420 }}>
              <h2 style={{ fontSize: "clamp(1.4rem, 2.5vw, 1.9rem)", fontWeight: 800, margin: "0 0 14px", lineHeight: 1.15, color: "#fff" }}>
                Una experiencia de <span style={{ color: "#7FE040" }}>otro nivel</span>
              </h2>
              ...
              <div style={{ display: "flex", gap: 28 }}>
                {[
                  { label: "Explorar", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg> },
                  { label: "Descubrir", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg> },
                  { label: "Conectar", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg> },
                  { label: "Comprar", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7FE040" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg> },
                ].map(step => (
        ...
        <div className="shell" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
          ...
          <div>
            <h2 style={{ fontSize: "clamp(1.5rem, 3vw, 2.2rem)", fontWeight: 800, margin: "0 0 16px" }}>
              Drokex <span style={{ color: "#7FE040" }}>Studio</span>
            </h2>
        ...
        <div className="shell">
          <div className="provider-final-cta" style={{
            ...
            <h2 style={{ fontSize: "clamp(1.5rem, 3vw, 2.2rem)", fontWeight: 800, margin: 0, lineHeight: 1.2, color: txt }}>
              Empieza hoy en <span style={{ color: "#7FE040" }}>Drokex</span><br />

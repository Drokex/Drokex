...
export default async function CategoriasPage({ searchParams }) {
  ...
  return (
    <main className={styles.cdkPage}>
      ...
      <div className={`shell ${styles.cdkLayout}`}>
        <CatalogSidebar />

        {/* ── Main ── */}
        <div className={styles.cdkMain}>
          ...
          <div className={styles.cdkGrid}>
            {products.length === 0 ? (
              <div className={styles.cdkNoResults}>
                ...
                <Link href="/productos" className={styles.cdkBtnPrimary}>Limpiar filtros</Link>
              </div>
              ...
              return (
                <article key={product.slug} className={styles.cdkCard}>
                  ...
                  <div className={styles.cdkCardBody}>
                    ...
                    <p className={styles.cdkCardOfferBadge}><span className={styles.cdkOfferDot} />Oferta activa</p>
          ...
          <div className={styles.cdkBottomTrust}>
            <div className={styles.cdkTrustItem}>
              ...
              <div>
                ...
                <a href="https://wa.me/573115312623?text=Hola%2C%20quiero%20publicar%20mis%20productos%20en%20Drokex" target="_blank" rel="noopener noreferrer" className={styles.cdkTrustLink}>

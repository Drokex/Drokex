  ...
  return (
    <div className="sp-page">
      ...
      <section style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "80px 20px" }}>
        <div>
          <p style={{ color: "#9be02f", fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>Próximamente</p>
          ...
          <Link href="/productos" style={{ display: "inline-block", padding: "14px 32px", background: "#9be02f", color: "#000", fontWeight: 700, borderRadius: 8 }}>
            Ver productos
          </Link>
        </div>
      </section>

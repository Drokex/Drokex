...
// Solo países de Latam. Los counts son placeholders de diseño (igual que CATEGORY_META /
// AVAILABILITY_META): el filtro `origen` todavía no consulta Product.originCountry.
const ORIGIN_DATA = [
  { name: "Colombia", flag: "🇨🇴", count: 189 },
  { name: "México", flag: "🇲🇽", count: 245 },
  { name: "Argentina", flag: "🇦🇷", count: 102 },
  { name: "Nicaragua", flag: "🇳🇮", count: 68 },
  { name: "Perú", flag: "🇵🇪", count: 54 },
];

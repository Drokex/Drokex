...
import DrokexGlobe from "@/app/drokex-world/globe-component";
import styles from "@/app/page.module.css";

const globalMarkets = [
  {
    id: "ni", label: "Nicaragua", flag: "🇳🇮", seller: "Camila Rivas", role: "Aliada comercial", badge: "CR",
    portrait: "/market-person-3.jpg", accent: "#7FE040", accentSoft: "rgba(127, 224, 64, 0.22)",
    orderLabel: "Pedido para NI", orderAmount: "US$ 125,00",
    headline: "Activa oportunidades comerciales para Nicaragua con una catálogo más clara.",
    description: "Adapta tu catálogo a mercados clave y muestra una propuesta mas confiable para compradores que necesitan velocidad, contexto y seguimiento.",
  },
  {
    id: "hn", label: "Honduras", flag: "🇭🇳", seller: "Sofia Ramirez", role: "Aliada comercial", badge: "SR",
    portrait: "/market-person-2.jpg", accent: "#6e87ff", accentSoft: "rgba(110, 135, 255, 0.2)",
    orderLabel: "Pedido para HN", orderAmount: "US$ 110,00",
    headline: "Convierte expansión regional en una experiencia más visual y más ágil.",
    description: "Desde el interes inicial hasta el pedido, Drokex puede mostrar una narrativa comercial distinta para cada pais objetivo.",
  },
  {
    id: "gt", label: "Guatemala", flag: "🇬🇹", seller: "Andrea Solis", role: "Proveedor exportador", badge: "AS",
    portrait: "/market-person-1.jpg", accent: "#7FE040", accentSoft: "rgba(127, 224, 64, 0.2)",
    orderLabel: "Pedido para GT", orderAmount: "US$ 94,00",
    headline: "Haz que tu oferta se sienta lista para crecer en Centroamerica.",
    description: "Con vistas comerciales mas ordenadas y mensajes mas claros, tus productos pueden generar confianza desde el primer contacto.",
  },
  {
    id: "sv", label: "El Salvador", flag: "🇸🇻", seller: "Mariana Perez", role: "Compradora mayorista", badge: "MP",
    portrait: "/market-person-3.jpg", accent: "#ff7a66", accentSoft: "rgba(255, 122, 102, 0.2)",
    orderLabel: "Pedido para SV", orderAmount: "US$ 138,00",
    headline: "Presenta una experiencia comercial pensada para El Salvador.",
    description: "Cada bandera puede activar otra catálogo, otra historia y otro ritmo de conversión para una expansión más inteligente.",
  },
  {
    id: "do", label: "República Dominicana", flag: "🇩🇴", seller: "Daniela Cruz", role: "Compradora mayorista", badge: "DC",
    portrait: "/market-person-1.jpg", accent: "#f97316", accentSoft: "rgba(249, 115, 22, 0.2)",
    orderLabel: "Pedido para DO", orderAmount: "US$ 142,00",
    headline: "Abre una entrada comercial mas directa para República Dominicana.",
    description: "La experiencia adapta mensajes, precios y contexto para que cada oportunidad internacional se sienta mas cercana.",
  },
  {
    id: "co", label: "Colombia", flag: "🇨🇴", seller: "Laura Torres", role: "Marca de consumo", badge: "LT",
    portrait: "/market-person-2.jpg", accent: "#18c4d9", accentSoft: "rgba(24, 196, 217, 0.2)",
    orderLabel: "Pedido para CO", orderAmount: "US$ 82,00",
    headline: "Activa mercados cercanos con una experiencia mas local y mas directa.",
    description: "Drokex ayuda a presentar catalogo, origen y oportunidad comercial con una capa visual lista para hablarle a cada mercado.",
  },
  {
    id: "pe", label: "Perú", flag: "🇵🇪", seller: "Renata Salas", role: "Distribuidora retail", badge: "RS",
    portrait: "/market-person-3.jpg", accent: "#ef4444", accentSoft: "rgba(239, 68, 68, 0.18)",
    orderLabel: "Pedido para PE", orderAmount: "US$ 118,00",
    headline: "Conecta productos y compradores en Perú con una catálogo mas confiable.",
    description: "Drokex ordena el contenido comercial para que el mercado vea disponibilidad, origen y propuesta con rapidez.",
  },
  {
    id: "mx", label: "México", flag: "🇲🇽", seller: "Valeria Mendez", role: "Distribuidora industrial", badge: "VM",
    portrait: "/market-person-3.jpg", accent: "#7FE040", accentSoft: "rgba(127, 224, 64, 0.2)",
    orderLabel: "Pedido para MX", orderAmount: "US$ 125,00",
...
export function MarketsSection() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (!marketPausedRef.current) setActiveMarket((prev) => (prev + 1) % globalMarkets.length);
    }, 3000);
      ...
      <div className="shell">
        <div className={styles.marketsStage}>
          <div className={styles.marketsRobotAccent} aria-hidden="true">
            <Image src="/markets-robot-right.png" alt="" width={538} height={744} sizes="(max-width: 960px) 0px, 280px" className={styles.marketsRobotImage} />
          </div>

          <div className={styles.marketsGrid}>
            <div className={styles.marketsContent}>
              <div className={styles.marketsBrand}>
                <Image src="/logo.png" alt="Drokex" width={550} height={144} sizes="(max-width: 720px) 220px, 320px" className={styles.marketsBrandLogo} />
                <p>Crece en todo el mundo</p>
              </div>

              <div className={styles.marketsInteractive}>
                <div className={styles.marketsRail} role="tablist" aria-label="Mercados">
                ...
                <div className={styles.marketsScene}>
                        ...
                        >
                          <div className={styles.marketCardFrame}>
                            <div className={styles.marketCardPhoto}>
                              <Image src={market.portrait} alt={market.seller} width={736} height={1103} sizes="240px" className={styles.marketCardPortrait} />
                            ...
                            <button type="button" className={styles.marketCardAction} onClick={() => handleMarketContact(market)}>
                              Contáctame ahora
                            </button>
                          </div>
                        </article>
                  ...
                  <div key={`${currentMarket.id}-pill`} className={styles.marketOrderPill} style={{ "--market-pill-accent": currentMarket.accent }}>
                    <span className={styles.marketOrderFlag} aria-hidden="true">{currentMarket.flag}</span>
...
const HOW_IT_WORKS = [
  {
    ...
    steps: [
      ...
      "Sigue bajando para ver más de la experiencia.",
...
export function DrokexWorldSection() {
